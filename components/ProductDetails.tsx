                        ...
                        <DialogPanel className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5">
                            ...
                            <div className="flex-1 flex flex-col gap-3">
                                {/* <div className="relative w-full h-40 bg-pattern bg-cover bg-center rounded-lg">
                                    <Image src={generateProductImageUrl(product)} alt="product model" fill priority className="object-contain" />
                                </div> */}

                                <div className="relative w-full h-40 rounded-lg">
                                    <Image src='/hero.png' alt="product model" fill priority className="object-contain" />
                                </div>
                            ...
                            <div className="flex-1 flex flex-col gap-2">
                                ...
                                <div className="mt-3 flex flex-wrap gap-4">
                                    {Object.entries(product).map(([key, value]) => (
                                        <div className="product-details__item w-full text-right" key={key}>
                                            <h4 className="product-details__item-left">
                                                {key.split('_').join(' ')}
                                            </h4>
                                            <p className="product-details__item-right">
                                                {value}
                                            </p>
                                        </div>
                                    ))}
